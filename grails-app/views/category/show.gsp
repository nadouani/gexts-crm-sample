            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="category.picture.label" default="Picture" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: categoryInstance, field: "picture")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="category.products.label" default="Products" /></td>
